...
3.  Service Requests by borough and status
4.  The different types of complaints
5.  Types of complaints that get resolved fastest/slowest along with the mean resolution time to close a request.
6.  What are the trends in service requests over time?
7.  Are there emerging trends or new issues that require attention based on recent service request data?
8.  Proportion of requests that were closed?
9.  NYC Dept that gets most issues?
